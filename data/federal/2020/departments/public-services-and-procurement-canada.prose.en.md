...
In the 2019-20 fiscal year, the portfolio spent {{totalSpending}}, or {{percentageOfFederal}} of total federal spending, on a Volume II appropriations basis.
...
<!-- verification: figures only via placeholders. Fact sheet 2020: entities = Department of Public Works and Government Services, Shared Services Canada, National Capital Commission, Canada Post Corporation; top transfers = payments in lieu of taxes + recoveries (negative). Rewritten 2026-07-06 after the gn-dg fix moved Shared Services Canada into this portfolio for 2020 (it was mislabeled in the source those years). Section tokens: stats, miniSankey; entities/historicalShare/lineItems auto-append. -->
