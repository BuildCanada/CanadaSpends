...
{{name}} spent {{totalSpending}} in the 2024–25 fiscal year, accounting for {{percentageOfFederal}} of total federal spending. This places the department among the larger recipients of federal appropriations, reflecting the scale of the benefit and compensation programs it administers on behalf of veterans across the country.
...
<!-- verification:
- totalSpending/percentageOfFederal match the fact sheet's totalSpending/percentageOfFederal fields for veterans-affairs.
- Named entities (Department of Veterans Affairs, Veterans Review and Appeal Board) both appear in topEntities/topMiniSankeyChildren, in descending order by amount.
- Named transfer payments (Pain and Suffering Compensation, Additional Pain and Suffering Compensation, Income Replacement Benefit, pensions for disability and death under the Pension Act and related authorities, Housekeeping and Grounds Maintenance) all appear in topTransferPayments, in descending order by used amount.
- No other figures or unsupported claims included.
-->
