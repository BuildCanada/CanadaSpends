...
<!-- verification:
- totalSpending/percentageOfFederal: match fact sheet totalSpending/percentageOfFederal fields for Fisheries, Oceans and the Canadian Coast Guard.
- basis: fact sheet basis is vol2_appropriations — Volume II Public Accounts appropriations statement is accurate.
- named entity: Department of Fisheries and Oceans — only entity in topEntities/topMiniSankeyChildren (single-entity portfolio, expected).
- vote structure: operating, capital, grants and contributions votes plus statutory amounts — matches the votes array (Vote one operating, Vote five capital, Vote ten grants and contributions, statutory amounts).
- named transfer programs: Integrated Aboriginal Programs Management Framework; Aquatic Species and Aquatic Habitat; Coastal Indigenous Prosperity Society / Great Bear Sea Project Finance for Permanence Community Prosperity Fund; Coast Conservation Endowment Fund Foundation / Great Bear Sea Project Finance for Permanence Marine Stewardship Fund; Integrated Fish and Seafood Sector Management Framework — all present in topTransferPayments, described in used-amount order. Grant/contribution categories match the fact sheet.
- Coast Guard operational roles and Great Lakes/St. Lawrence references are generic mandate background, not drawn from the fact sheet.
