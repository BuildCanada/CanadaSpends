...
<!-- verification: totalSpending/percentageOfFederal are the only figures, both placeholders. Mandate paragraph reflects the three entities actually present in topEntities (Department of the Environment, Parks Canada Agency, Impact Assessment Agency of Canada). Entities ordered by value (2.437396 / 1.452548 / 0.098232). Transfer payments named match the top 5 topTransferPayments descriptions in descending order by used amount. No dollar/percent literals. No claims beyond fact sheet. -->
