...
<!-- verification: totalSpending/percentageOfFederal are the only figures, both placeholders. Mandate paragraph (para 1) is generic, widely-known background, no fact-sheet-specific numbers. Entities named -- Department of Agriculture and Agri-Food, Canadian Grain Commission, Canadian Dairy Commission -- match topEntities, ordered by value (4.204232 / 0.02532 / 0.005376). Transfer payments named -- AgriInsurance, AgriStability, Dairy Direct Payment Program, Sustainable Canadian Agricultural Partnership, AgriRecovery -- match the top 5 topTransferPayments descriptions, in descending order by used amount. No dollar/percent literals. No claims beyond fact sheet. -->
