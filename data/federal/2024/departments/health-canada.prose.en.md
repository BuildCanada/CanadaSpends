...
<!--
Figures: EN spending para uses {{totalSpending}} ($13.96B) and {{percentageOfFederal}}
(2.7%), matching the JSON (vol2_appropriations) and charts. FR literal "13,7 milliards"
replaced by token. "$513.9 billion" retained (matches summary.json).
Restored from dropped entity list, verified against JSON entities: Department of Health
$7.1B, PHAC $4.4B, CIHR $1.3B, CFIA $1.1B. Transfers verified against transferPayments:
shared health priorities $2.5B, home care/mental health $1.8B, research grants $1.1B,
dental benefits.
Dropped "ranked tenth", "10 departments = 73.2%", "since 1995 / +74.9% / -19.9% /
3.14 pp lower than 1995" (pre-2014 data absent from JSON; share was 2.57% in 2014 vs
